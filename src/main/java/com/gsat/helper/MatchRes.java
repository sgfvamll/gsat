...
public class MatchRes {
    ...
    private long offset;
    private long xrefNum;
    private String funcName;
    private String funcSign;
    private String funcType;
    private List<Integer> criticalIndex;

    public MatchRes(long offset, String funcName, String funcSign, String funcType, List<Integer> criticalIndex, long xrefNum) {
        this.offset = offset;
