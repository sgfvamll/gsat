...
public class ColoredPrint {
    ...
    public static void log(String style, String level, String content, Object... args) {
        var methodName = Thread.currentThread().getStackTrace()[3].getMethodName();
        System.out.print(style + "[" + level + ":" + methodName + "] " + String.format(content, args));
        System.out.println(ANSI_RESET);
    }

    public static void error(String content, Object... args) {
        ColoredPrint.log(ANSI_RED,"ERROR", content, args);
    }

    public static void warning(String content, Object... args) {
        ColoredPrint.log(ANSI_PURPLE, "WARNING", content, args);
    }

    public static void info(String content, Object... args) {
        ColoredPrint.log(ANSI_WHITE, "INFO", content, args);
    }

    public static void Print(String content) {
        System.out.print(ANSI_WHITE + content);
